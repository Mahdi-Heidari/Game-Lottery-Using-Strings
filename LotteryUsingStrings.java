...
public class LotteryUsingStrings {
    ...
    public static void main(String[] args) {
        ...
        String lottery = ("" + (int) (10 + random.nextFloat() * 89));

        // Prompting the user to enter a guess
        System.out.print("Enter your lottery pick (two digits) :\t");
        String guess = reader.next().trim();

        // Checking the guess accuracy
        while (guess.length() != 2) {
            System.out.println("Enter a two-digit number:\t");
            guess = reader.next().trim();
        }
        ...
        } else if (lottery.contains("" + guess.charAt(0)) && lottery.contains("" + guess.charAt(1))) {
